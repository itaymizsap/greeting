...
@ComponentScan("com.itay.spring.tutorials.microservices")
@EnableTransactionManagement
@EnableCaching
public class AppConfig {

    private @NotNull
    String welcome;//Any property must have a setter method in order to enable Spring container set from properties file
